// Hand-drawn dish glyphs for recipe tiles — one consistent line-icon family
// (1.7 stroke, round caps) instead of platform emoji, so every card looks like
// it belongs to this app. Keys match the glyph names recipeImagery resolves.
// Dots and fills use the current colour; everything scales with the svg box.
