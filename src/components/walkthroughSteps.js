...
export const WALKTHROUGH_STEPS = [
  ...
  },
  {
    ...
    body: "Browse the whole library as tiles on the Recipes tab. Rate what you cook, tap the heart to save favourites, and let “For you” suggest dishes from your ratings — then drop any straight onto a night.",
    Scene: SceneRecipes,
  },
  {
    id: "stock",
